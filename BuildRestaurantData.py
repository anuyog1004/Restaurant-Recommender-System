...
for category in category_ids:
	...
	while(True):
		r = requests.get(request_url,headers={"user-key":"576b8aee91166bc426d076945be5d8fa"},params={"entity_id":1,"entity_type":"city","establishment_type":category,"start":start_index})
